...
public class Eapp3 extends Fragment {
    ...
    private class DisplayData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                productLists = DatabaseClient.getInstance(getActivity().getApplicationContext()).getAppDatabase().loginDao().getClothesProducts();
